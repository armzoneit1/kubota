...
const SaturdayWorkdayList = () => {
  ...
  const schedules = getList("saturdayWorkday", page, search, sortBy, year, "")
  ...
  return (
    <TabLayout index={1} setSearch={setSearch} search={search}>
      <List
...
export default SaturdayWorkdayList
