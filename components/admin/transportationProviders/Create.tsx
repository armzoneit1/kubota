      ...
      >
        <Flex width="100%" justifyContent="space-between" my={5}>
          <Flex justifyContent="center" flexDirection="column">
            ...
            <HStack>
              <NextLink href={"/admin/transportationProviders"} passHref>
                <Link _hover={{}} _focus={{}}>
              ...
              <Text>{">"}</Text>
              <Text fontStyle="italic">เพิ่มผู้ให้บริการ</Text>
            </HStack>
          </Flex>
        </Flex>
        <Tabs colorScheme="primary">
          <TabList>
            <Tab>ข้อมูลผู้ให้บริการ</Tab>
            <Tab isDisabled>รถ</Tab>
            <Tab isDisabled>คนขับรถ</Tab>
          </TabList>
          <TabPanels>
            <TabPanel pt={{ base: 8, md: 16 }} px={0}>
                          ...
                          >
                            ...
                            >
                              <NumberInput>
                                <NumberInputField
                                  {...register(
                                    `vehicleTypes.${index}.seatCapacity` as const,
                                    {
                                      required: "กรุณากรอก",
                                      valueAsNumber: true,
                                    }
