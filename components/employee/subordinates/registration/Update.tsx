...
import { RegisterBookingBusInfoDataTypes } from "../../../../data-hooks/subordinates/types"
...
type UpdateProps = {
  data: RegisterBookingBusInfoDataTypes
  ...
  const {
    ...
    defaultValues: {
      ...
      isDisplayDefaultForSubordinateBooking:
        data?.isDisplayDefaultForSubordinateBooking ?? false,
          ...
          <Flex width="100%" justifyContent="space-between" mt={5} mb={12}>
            <Flex justifyContent="center" flexDirection="column">
              <HStack spacing={6}>
                ...
                <Text>{">"}</Text>
                <Text color="#00000080">แก้ไขพนักงาน</Text>
              </HStack>
            </Flex>
          </Flex>
