...
import { BookingBusUserDataTypes } from "../../../data-hooks/me/types"
...
const Update = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      supervisorEmployeeNo: data?.supervisorEmployeeNo
        ? me?.myHrEmployee?.supervisorEmployeeNo
        : data?.supervisorEmployeeNoFromApproval ?? "-",
      supervisorEmployeeName: data?.supervisorEmployeeNo
        ? `${me?.myHrEmployee?.supervisorTitle}${me?.myHrEmployee?.supervisorFirstName} ${me?.myHrEmployee?.supervisorLastName} (Manual)`
        : data?.supervisorEmployeeNoFromApproval
        ? `${me?.myHrEmployee?.supervisorTitleFromApproval}${me?.myHrEmployee?.supervisorFirstNameFromApproval} ${me?.myHrEmployee?.supervisorLastNameFromApproval} (HrConnect)`
        : "-",
      phoneNo: data?.phoneNo ? data?.phoneNo : "-",
      employeeUsageInfo: data?.employeeUsageInfo
        ? {
            morning: [
              {
                dayOfWeek: "monday",
                busLineId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.0.busStopId")
                    ? filter(areaMorningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "morning.0.busStopId")
                        )
                      )[0]
                    : null,
                busStopLineMappingId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.0.busStopId") &&
                  get(data?.employeeUsageInfo, "morning.0.busStopLineMappingId")
                    ? filter(
                        filter(
                          areaMorningOptions,
                          filter(areaMorningOptions, (v) =>
              ...
              },
              {
                ...
                busLineId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.1.busStopId")
                    ? filter(areaMorningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "morning.1.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.1.busStopId") &&
                  get(data?.employeeUsageInfo, "morning.1.busStopLineMappingId")
                    ? filter(
                        filter(areaMorningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "morning.1.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.2.busStopId")
                    ? filter(areaMorningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "morning.2.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.2.busStopId") &&
                  get(data?.employeeUsageInfo, "morning.2.busStopLineMappingId")
                    ? filter(
                        filter(areaMorningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "morning.2.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.3.busStopId")
                    ? filter(areaMorningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "morning.3.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.3.busStopId") &&
                  get(data?.employeeUsageInfo, "morning.3.busStopLineMappingId")
                    ? filter(
                        filter(areaMorningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "morning.3.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.4.busStopId")
                    ? filter(areaMorningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "morning.4.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.4.busStopId") &&
                  get(data?.employeeUsageInfo, "morning.4.busStopLineMappingId")
                    ? filter(
                        filter(areaMorningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "morning.4.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.5.busStopId")
                    ? filter(areaMorningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "morning.5.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.5.busStopId") &&
                  get(data?.employeeUsageInfo, "morning.5.busStopLineMappingId")
                    ? filter(
                        filter(areaMorningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "morning.5.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.6.busStopId")
                    ? filter(areaMorningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "morning.6.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaMorningOptions &&
                  get(data?.employeeUsageInfo, "morning.6.busStopId") &&
                  get(data?.employeeUsageInfo, "morning.6.busStopLineMappingId")
                    ? filter(
                        filter(areaMorningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "morning.6.busStopId")
            ...
            evening: [
              {
                ...
                busLineId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.0.busStopId")
                    ? filter(areaEveningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "evening.0.busStopId")
                        )
                      )[0]
                ...
                busStopLineMappingId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.0.busStopId") &&
                  get(data?.employeeUsageInfo, "evening.0.busStopLineMappingId")
                    ? filter(
                        filter(areaEveningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "evening.0.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.1.busStopId")
                    ? filter(areaEveningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "evening.1.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.1.busStopId") &&
                  get(data?.employeeUsageInfo, "evening.1.busStopLineMappingId")
                    ? filter(
                        filter(areaEveningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "evening.1.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.2.busStopId")
                    ? filter(areaEveningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "evening.2.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.2.busStopId") &&
                  get(data?.employeeUsageInfo, "evening.2.busStopLineMappingId")
                    ? filter(
                        filter(areaEveningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "evening.2.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.3.busStopId")
                    ? filter(areaEveningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "evening.3.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.3.busStopId") &&
                  get(data?.employeeUsageInfo, "evening.3.busStopLineMappingId")
                    ? filter(
                        filter(areaEveningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "evening.3.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.4.busStopId")
                    ? filter(areaEveningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "evening.4.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.4.busStopId") &&
                  get(data?.employeeUsageInfo, "evening.4.busStopLineMappingId")
                    ? filter(
                        filter(areaEveningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "evening.4.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.5.busStopId")
                    ? filter(areaEveningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "evening.5.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.5.busStopId") &&
                  get(data?.employeeUsageInfo, "evening.5.busStopLineMappingId")
                    ? filter(
                        filter(areaEveningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "evening.5.busStopId")
              ...
              },
              {
                ...
                busLineId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.6.busStopId")
                    ? filter(areaEveningOptions, (v) =>
                        v.busStopIds.includes(
                          get(data?.employeeUsageInfo, "evening.6.busStopId")
                        )
                ...
                busStopLineMappingId:
                  areaEveningOptions &&
                  get(data?.employeeUsageInfo, "evening.6.busStopId") &&
                  get(data?.employeeUsageInfo, "evening.6.busStopLineMappingId")
                    ? filter(
                        filter(areaEveningOptions, (v) =>
                          v.busStopIds.includes(
                            get(data?.employeeUsageInfo, "evening.6.busStopId")
  ...
  return (
    <>
      <Head>
        <title>ข้อมูลลงทะเบียน</title>
        <meta name="description" content="registration" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <ConfirmDialog
        title=""
        content="หากยืนยันการปิดใช้งานบัญชี รายการจองในอนาคตของคุณจะถูกยกเลิก"
        onSubmit={() => {
          submit(values)
        }}
        isLoading={isLoading}
