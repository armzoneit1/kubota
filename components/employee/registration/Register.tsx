...
import { MyHrEmployeeDataTypes } from "../../../data-hooks/me/types"
  ...
  const {
    ...
    defaultValues: {
      ...
      supervisorEmployeeName: data?.supervisorEmployeeNo
        ? `${data?.supervisorTitle}${data?.supervisorFirstName} ${data?.supervisorLastName} (Manual)`
        : data?.supervisorEmployeeNoFromApproval
        ? `${data?.supervisorTitleFromApproval}${data?.supervisorFirstNameFromApproval} ${data?.supervisorLastNameFromApproval} (HrConnect)`
        : "-",
